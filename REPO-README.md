...
## Banco de perguntas (94 ativas no total)
...
Categorias: `personalidade` (12), `temperamento` (12), `apego` (14), `feridas_infancia` (13), `linguagem_amor` (12), `valores_vida` (14 ativas), `conhecer_melhor` (17).
...
`VAL13`/`VAL14`/`VAL15` (juntar patrimônio, regime de bens do casamento, papel de cada um na vida financeira) e `CON17` (qual gesto faz você se sentir mais amado(a)) foram adicionadas depois que Tamyris e Saulo já tinham respondido tudo — ver "Completar pergunta(s) nova(s)" abaixo pra como isso funciona sem perder nenhuma resposta anterior.
